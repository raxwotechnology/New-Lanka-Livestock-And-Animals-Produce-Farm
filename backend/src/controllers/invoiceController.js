...
import { sendInvoiceCreationSms } from '../services/smsService.js';
import { sendInvoiceCreationEmail } from '../services/emailService.js';
...
export const createInvoice = asyncHandler(async (req, res) => {
    ...
    // sendInvoiceCreationSms(invoice).catch(err => console.error(err));
    sendInvoiceCreationEmail(invoice).catch(err => console.error(err));
...
export const getInvoices = asyncHandler(async (req, res) => {
    ...
    const {
        search, customerId, paymentStatus, status, agingBucket, paymentMethod,
        startDate, endDate,
        page = 1, limit = 20,
...
export const updateInvoice = asyncHandler(async (req, res) => {
    ...
    const { customerId, items, dueDate, invoiceDate, invoiceType, paymentMethod, notes, paymentInstructions, shippingCost } = req.body;
