...
export default function PosPage() {
    ...
    return (
        <div className="absolute inset-0 flex flex-col bg-gray-100 overflow-hidden z-10">
                            ...
                            {filteredProducts.map((p) => {
                                ...
                                return (
                                    <button
                                        ...
                                        onClick={() => addToCart(p)}
                                        className={`
                                            relative text-left bg-white rounded-2xl p-3 transition-all duration-150 active:scale-95 hover:shadow-lg hover:-translate-y-0.5 cursor-pointer
                                            ${inCart
