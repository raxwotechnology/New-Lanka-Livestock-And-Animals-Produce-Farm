    ...
    return (
        <div>
            <PageHeader
                ...
                actions={canAdd && <Button variant="primary" onClick={() => openForm()}><Plus size={16} className="mr-1.5" />Add Brand</Button>}
            />
            ...
            <Card>
                {isLoading ? (
                    ...
                    <EmptyState
                        ...
                        action={canAdd && <Button variant="primary" onClick={() => openForm()}><Plus size={16} className="mr-1.5" />Add Brand</Button>}
                    />
                ) : (
