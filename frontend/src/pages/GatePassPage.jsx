        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    ...
                    {['admin', 'superadmin', 'md'].includes(useAuthStore.getState().user?.role) && (
            ...
            <div className="space-y-3">
                {loading ? (
                    ...
                    <EmptyState
                        ...
                        description={filters.search || filters.status ? 'Try adjusting your filters' : 'Create a gate pass to log vehicle movement'}
                    />
                ) : passes.map(gp => (
