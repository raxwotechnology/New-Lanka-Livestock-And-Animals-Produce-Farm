...
import ManagerAccountModal from '../features/users/ManagerAccountModal';
            ...
            <PageHeader
                ...
                actions={
                    <div className="flex gap-2">
                        <Button variant="outline" className="border-orange-500 text-orange-600 hover:bg-orange-50" onClick={() => setIsManagerFormOpen(true)}>
                            <UserCog size={16} className="mr-1.5" /> Create Manager
                        </Button>
