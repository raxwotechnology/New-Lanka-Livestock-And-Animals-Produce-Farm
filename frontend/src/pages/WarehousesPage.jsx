...
export default function WarehousesPage() {
    ...
    if (isManager) {
        warehouses = warehouses.filter(w => isRecordRecentlyCreated(w, createdRecords) || isRecordApprovedForEdit(w, approvedEditRecords));
    }
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (r) => (isAdmin || isRecordApprovedForEdit(r, useAuthStore.getState().approvedEditRecords)) && (
            ...
            <Card>
                    ...
                    {isLoading ? (
                        ...
                        <EmptyState
                            ...
                            action={canAdd && <Button variant="primary" onClick={() => setIsFormOpen(true)}>
                                <Plus size={16} className="mr-1.5" /> Add Warehouse
                            </Button>}
                        />
                    ) : (
