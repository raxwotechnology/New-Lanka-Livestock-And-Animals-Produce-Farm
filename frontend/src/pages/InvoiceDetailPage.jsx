...
export default function InvoiceDetailPage() {
    ...
    if (isLoading) return <div className="py-16 text-center text-gray-500">Loading invoice...</div>;
    if (!inv) {
        return (
            <div className="py-16 text-center text-gray-500 max-w-md mx-auto">
                <p className="text-lg font-bold text-red-600 mb-2">Invoice Not Found</p>
                <p className="text-sm text-gray-600 mb-4">The invoice you are looking for does not exist or has been removed.</p>
    ...
    const canEdit = !isDataEntry || isRecordApprovedForEdit(inv, approvedEditRecords) || isRecordRecentlyCreated(inv, createdRecords);
    ...
    const companyInfo = {
        name: 'New Lanka Livestock And Animals Produce Farm',
        address: 'Rathugala ,Wellassa ,Galgamuwa, Inginiygala.',
        phone: '0760348159',
        email: 'janstephan06@gmail.com',
        logo: '/logo.jpg',
    };
                    ...
                    <div className="flex gap-2 flex-wrap">
                        ...
                        {canEdit && (
                            <Button variant="outline" onClick={() => navigate(`/invoices/${inv._id}/edit`)}>
                                <Edit size={16} className="mr-1.5" /> Edit Invoice
                            </Button>
                        )}
                        <select
                        ...
                        >
                            ...
                            <option value="half-a4">A4 Half</option>
